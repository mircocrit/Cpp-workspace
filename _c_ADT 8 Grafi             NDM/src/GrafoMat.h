...
template<class E, class P> 
 ...
 public:
	...
	void* info;
	InfoArco<P>* archi;
	InfoNodo(){ 	info = 0; 		vuoto = true; }
	~InfoNodo(){	if (!vuoto) delete [] archi; }
};
...
template<class E, class P>
 ...
 public:
    ...
    GrafoMat(int);
    ~GrafoMat(){	delete [] matrice;};

    bool vuoto() const{	return (nodi == 0);};
    void insNodo(NodoG&);
    ...
    Etichetta leggiEtichetta(Nodo n) const {	return matrice[n.getId()].etichetta;};
    void scriviEtichetta(Nodo n, Etichetta etichetta) {	matrice[n.getId()].etichetta = etichetta;};
    Peso leggiPeso(Nodo n1, Nodo n2) const {	return matrice[n1.getId()].archi[n2.getId()].peso;};
    void scriviPeso(Nodo n1, Nodo n2, Peso peso) {	matrice[n1.getId()].archi[n2.getId()].peso = peso;};
	int numNodi(){		return nodi;};
	int numArchi(){		return archi;};
 private:
...
/*
template<class E, class P>
	GrafoMat<E, P>::~GrafoMat() {	delete [] matrice;}

template<class E, class P>
	bool GrafoMat<E, P>::vuoto() const {	return (nodi == 0);}
*/
template<class E, class P>
...
/*
template<class E, class P>
	E GrafoMat<E, P>::leggiEtichetta(Nodo n) const {	return matrice[n.getId()].etichetta;}

template<class E, class P>
	void GrafoMat<E, P>::scriviEtichetta(Nodo n, E etichetta) {	matrice[n.getId()].etichetta = etichetta;}

template<class E, class P>
	P GrafoMat<E, P>::leggiPeso(Nodo n1, Nodo n2) const {	return matrice[n1.getId()].archi[n2.getId()].peso;}

template<class E, class P>
	void GrafoMat<E, P>::scriviPeso(Nodo n1, Nodo n2, P peso) {	matrice[n1.getId()].archi[n2.getId()].peso = peso;}
*/
#endif
