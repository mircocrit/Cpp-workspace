...
template<class E, class P> 
 class InfoNodo {
   public:
	E   etichetta;
	bool vuoto;
	void* info;//c'e una matrice con oggetti di infonodo con all'interno un array che ha gli archi
...
//implementaizone grafo con liste

template<class E, class P>
  class GrafoList :								 public Grafo<E, P, NodoG > {
 public://ridenominazione
    typedef E 	Etichetta;
    typedef P 	Peso;
    typedef NodoG 		Nodo;
...
/*
template<class E, class P>
  GrafoList<E, P>::~GrafoList() {  	delete [] matrice;}

template<class E, class P>
  bool GrafoList<E, P>::vuoto() const {  	return (nodi == 0);}
*/
template<class E, class P>
...
template<class E, class P>
  ...
  ListaNodi list;  // TODO: costruire la lista dei nodi dalla lista degli adiacenti matrice[n.getId()].archi
  return list;
...
/*
template<class E, class P>
  E GrafoList<E, P>::leggiEtichetta(Nodo n) const {  return matrice[n.getId()].etichetta;}

template<class E, class P>
  void GrafoList<E, P>::scriviEtichetta(Nodo n, E etichetta) {  matrice[n.getId()].etichetta = etichetta;}
*/
template<class E, class P>
